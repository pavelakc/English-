...
async def set_user_lang(user_id: str, lang: str):
    ...
    if existing:
        ...
        await sb_post("/rest/v1/user_settings", {"user_id": user_id, "language": lang})
...
async def auto_translate(word, from_lang="en"):
    if not ANTHROPIC_KEY:
        return ""
    lang_names = {"en": "English", "de": "German", "es": "Spanish", "ko": "Korean"}
...
async def all_callbacks(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("lang_"):
        ...
        lang_names = {"en": "🇬🇧 Английский", "de": "🇩🇪 Немецкий", "es": "🇪🇸 Испанский", "ko": "🇰🇷 Корейский"}
